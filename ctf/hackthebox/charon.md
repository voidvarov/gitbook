...
![](.gitbook/img/htb/charon/yogurt_site.png)
...
![](.gitbook/img/htb/charon/crackstation_1.png)
...
![](.gitbook/img/htb/charon/error_2.png)

Inspecting the site I find a hidden parameter


![](.gitbook/img/htb/charon/hidden_1.png)
...
![](.gitbook/img/htb/charon/uncommenting.png)

remove the hidden type from the input


![](.gitbook/img/htb/charon/uncommenting_2.png)

decode the field name 

![](.gitbook/img/htb/charon/field_name_1.png)



![](.gitbook/img/htb/charon/field_name_2.png)


another field appears in the website 


![](.gitbook/img/htb/charon/new_field.png)

this field allows to change the filename of the uploaded file


![](.gitbook/img/htb/charon/field_1.png)

to exploit this first I upload an image with a filename shell.php


![](.gitbook/img/htb/charon/upload_1.png)

I change the file content to a webshell


![](.gitbook/img/htb/charon/upload_2.png)

a success message confirms the upload


![](.gitbook/img/htb/charon/upload_3.png)

and I'm able to execute commands remotely


![](.gitbook/img/htb/charon/command_1.png)
