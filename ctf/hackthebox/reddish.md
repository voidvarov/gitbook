...
![import clipboard](.gitbook/assets/htb/reddish/import_clipboard.png)
...
![import nodes](.gitbook/assets/htb/reddish/import_nodes.png)

Click on the node that shows the IP and Port.

![ipport node](.gitbook/assets/htb/reddish/ipport_node.png)
...
![deploy](.gitbook/assets/htb/reddish/deploy_shell.png)

A reverse shell is received.

![hostname container 1](.gitbook/assets/htb/reddish/hostname_container_1.png)
...
![shell container 1](.gitbook/assets/htb/reddish/shell_container_1.png)
...
![nodered hostscansh](.gitbook/assets/htb/reddish/nodered_hostscansh.png)
...
![netscan hosts port](.gitbook/assets/htb/reddish/netscan_hosts_ports.png)
...
![port 81 forward](.gitbook/assets/htb/reddish/port81forward.png)
...
![source code](.gitbook/assets/htb/reddish/source_container_1.png)
...
![rce 172.19.0.2](.gitbook/assets/htb/reddish/rce_172_19_0_2.png)
...
![cron www](.gitbook/assets/htb/reddish/cron_task_www.png) 
...
```
![rsync flaw](.gitbook/assets/htb/reddish/rsync_flaw.png)
...
![rsync exploit](.gitbook/assets/htb/reddish/rsync_exploit.png)
...
![finding backup](.gitbook/assets/htb/reddish/finding_backup.png)
...
![crond](.gitbook/assets/htb/reddish/crond.png)
...
![revshell on backup](.gitbook/assets/htb/reddish/revshell_backup.png)
...
![mount backup](.gitbook/assets/htb/reddish/mount_backup.png)
...
![mounted reddish](.gitbook/assets/htb/reddish/mounted_reddish.png)

To establish a reverse shell, set up a crontab on the reddish machine to grant access to the attacker machine.

![creating cron](.gitbook/assets/htb/reddish/creating_cron.png)

And finally root is obtained.

![root](.gitbook/assets/htb/reddish/root.png)

Final map

![map](.gitbook/assets/htb/reddish/reddishmap.png)
