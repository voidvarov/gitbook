...
![import clipboard](.gitbook/img/htb/reddish/import_clipboard.png)
...
![import nodes](.gitbook/img/htb/reddish/import_nodes.png)

Click on the node that shows the IP and Port.

![ipport node](.gitbook/img/htb/reddish/ipport_node.png)
...
![deploy](.gitbook/img/htb/reddish/deploy_shell.png)

A reverse shell is received.

![hostname container 1](.gitbook/img/htb/reddish/hostname_container_1.png)
...
![shell container 1](.gitbook/img/htb/reddish/shell_container_1.png)
...
![nodered hostscansh](.gitbook/img/htb/reddish/nodered_hostscansh.png)
...
![netscan hosts port](.gitbook/img/htb/reddish/netscan_hosts_ports.png)
...
![port 81 forward](.gitbook/img/htb/reddish/port81forward.png)
...
![source code](.gitbook/img/htb/reddish/source_container_1.png)
...
![rce 172.19.0.2](.gitbook/img/htb/reddish/rce_172_19_0_2.png)
...
![cron www](.gitbook/img/htb/reddish/cron_task_www.png) 
...
```
![rsync flaw](.gitbook/img/htb/reddish/rsync_flaw.png)
...
![rsync exploit](.gitbook/img/htb/reddish/rsync_exploit.png)
...
![finding backup](.gitbook/img/htb/reddish/finding_backup.png)
...
![crond](.gitbook/img/htb/reddish/crond.png)
...
![revshell on backup](.gitbook/img/htb/reddish/revshell_backup.png)
...
![mount backup](.gitbook/img/htb/reddish/mount_backup.png)
...
![mounted reddish](.gitbook/img/htb/reddish/mounted_reddish.png)

To establish a reverse shell, set up a crontab on the reddish machine to grant access to the attacker machine.

![creating cron](.gitbook/img/htb/reddish/creating_cron.png)

And finally root is obtained.

![root](.gitbook/img/htb/reddish/root.png)

Final map

![map](.gitbook/img/htb/reddish/reddishmap.png)
