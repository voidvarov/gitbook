...
![Desktop View](.gitbook/assets/htb/buff/contact_php.png)
...
![Desktop View](.gitbook/assets/htb/buff/file_open.png)

2. click repeatedly on the run button until the program starts

![Desktop View](.gitbook/assets/htb/buff/run_button.png)
...
![Desktop View](.gitbook/assets/htb/buff/registers_1.png)
...
![Desktop View](.gitbook/assets/htb/buff/buttons.png)
...
![Desktop View](.gitbook/assets/htb/buff/registers_2.png)
...
![Desktop View](.gitbook/assets/htb/buff/registers_3.png)
...
![Desktop View](.gitbook/assets/htb/buff/esp_1.png)
...
![Desktop View](.gitbook/assets/htb/buff/no_bad_chars.png)
...
![Desktop View](.gitbook/assets/htb/buff/erc_1.png)
...
![Desktop View](.gitbook/assets/htb/buff/no_bad_chars_2.png)
...
![Desktop View](.gitbook/assets/htb/buff/moduleinfo_1.png)
...
![Desktop View](.gitbook/assets/htb/buff/module_1.png)

I right click on the start address and copy the value 

![Desktop View](.gitbook/assets/htb/buff/copy_start_address.png)

I click on the References tab

![Desktop View](.gitbook/assets/htb/buff/references_tab.png)

On the command prompt I type `findall 00401000,ffe4` looking for a jmp esp address in its hexadecimal form which is FF E4

![Desktop View](.gitbook/assets/htb/buff/findall_1.png)

and I can use any of these instructions 


![Desktop View](.gitbook/assets/htb/buff/instructions_1.png)
